...
`dartR.popgenomics` aims to support analysis of SNP and silicodart data to study population structure. For example running structure and estimating effective population sizes
